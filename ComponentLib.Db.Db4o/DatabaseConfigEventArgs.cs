...
// <time>15:09</time>
// <summary>Defines the DatabaseConfigEventArgs class.</summary>
//-----------------------------------------------------------------------
...
namespace ComponentLib.Db.Db4o
{
    ...
    public class DatabaseConfigEventArgs : EventArgs
    {
        readonly IEmbeddedConfiguration cfg;
        
        public DatabaseConfigEventArgs(IEmbeddedConfiguration config)
        {
            cfg = config;
        }
